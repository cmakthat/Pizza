...
class FirstViewController: UIViewController, UINavigationControllerDelegate, UIImagePickerControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        self.tapGesture = UITapGestureRecognizer(target: self, action: #selector(FirstViewController.imageTapped))
        ...
        self.submitButton.addTarget(self, action: #selector(FirstViewController.submitAction), for: .touchUpInside)
